...
const STROKES = [
  { d: "M 124 116 C 122 144 122 196 122 256",                            len: 130, label: "DISCOVER", lx: 80,  ly: 96,  shimmer: 0   },
  { d: "M 122 158 C 124 130 148 116 174 122 C 198 128 208 152 208 178",  len: 160, label: "DEFINE",    lx: 162, ly: 88,  shimmer: 0.7 },
  { d: "M 208 178 C 208 200 208 230 210 256",                            len: 100, label: "BUILD",     lx: 275, ly: 302, shimmer: 1.4, below: true },
  ...
  { d: "M 332 178 C 332 200 332 230 334 256",                            len: 100, label: "ITERATE",   lx: 388, ly: 302, shimmer: 3.5, below: true },
];
        ...
        {STROKES.map((s, i) => (
          <g key={i}>
            ...
            <text
              className="jj-label"
              style={{ "--scene-delay": delay(i) } as React.CSSProperties}
              x={s.lx} y={s.below ? s.ly + 18 : s.ly - 10} textAnchor="middle"
              dominantBaseline={s.below ? "hanging" : "auto"}
              fontFamily="var(--mono)"
